...
extern void preCalc_terms_season(F32PTR SEASON_TERMS,F32PTR SEASON_SQR_CSUM,int N,F32 PERIOD,int maxSeasonOrder);
...
extern void preCalc_XmarsTerms_extra_fmt4(F32PTR COEFF_A,F32PTR COEFF_B,I32 N);
