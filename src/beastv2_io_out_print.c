...
{	
	...
	Print("   metadata%cmissingValue     = %s\n",   meta->missingValue!=meta->missingValue, filler, "NaN" );
	...
	Print("   extra%cncpStatMethod        = '%s'\n", hasAlways && extra->ncpStatMethod == StatMEAN, filler, "mean")  //haromic season basis
	Print("   extra%cncpStatMethod        = '%s'\n", hasAlways && extra->ncpStatMethod == StatMEDIAN, filler, "median")  //haromic season basis
	Print("   extra%cncpStatMethod        = '%s'\n", hasAlways && extra->ncpStatMethod == StatMODE, filler, "mode")  //haromic season basis
